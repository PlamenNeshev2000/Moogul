  ...
  <div class="login-center">
    <form class="" action="register.php" method="post" onsubmit="return validation()">
      <div class="field form-group">
        ...
        <input type="text" class="form-control lr" name="name" value="<?php echo escape(Input::get('name')); ?>" id="name"
          autocomplete="off">
      ...
      <div class="field form-group">
        ...
        <input type="text" class="form-control lr" name="email" value="<?php echo escape(Input::get('email')); ?>"
      ...
      <div class="field form-group">
        ...
        <input type="text" class="form-control lr" name="username" value="<?php echo escape(Input::get('username')); ?>"
      ...
      <div class="field form-group">
        ...
        <input type="password" class="form-control lr" name="password" value="" id="pass" autocomplete="off">
        <span class="danger" id="passwords"> </span>
      </div>

      <div class="field form-group">
        <label class="lable" for="password_again">Enter your password again</label>
        <input type="password" class="form-control lr" name="password_again" value="" id="conpass" autocomplete="off">
