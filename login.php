    ...
    <div class='change boxbox'>
      <form class="" action="login.php" method="post" onsubmit="return validation()">
        ...
        <div class="field form-group">
          ...
          <input type="text" class="form-control ctrl lr" name="username" id="username" autocomplete="off">
          <span class="danger" id="usernames"> </span>
        </div>

        <div class="field form-group">
          <label for="password" class='textchange'>Password:</label>
          <input type="password" class="form-control ctrl lr" name="password" id="password" autocomplete="off">
