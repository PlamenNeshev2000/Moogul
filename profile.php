...
<body id="body-pd">
  ...
  <div class="profile-center">
    ...
    <div class="p-details-details">
      ...
      <br>
      <a href="changepassword.php"><button class="btn btn-fav-res btn-lg llrr">Change Password</button></a>
      <a href="logout.php"><button class="btn btn-fav-res btn-lg llrr">Logout</button></a>

      <?php
          if($user->hasPermission('admin')) {
            echo "<p class='role'>You are a Teacher!</p>";
            echo "<a href='adminview.php'><button class='btn btn-fav-res btn-lg llrr'>View All Users</button></a>";
          }
          else if($user->hasPermission('user')) {
            echo "<p class='role2'>You are a Student!</p>";
          }
          ?>
      </div>
    </div>
